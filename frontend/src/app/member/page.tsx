          ...
          <div className="flex flex-col space-y-3 md:space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
            <div>
              ...
              <p className="text-green-100 text-sm md:text-base lg:text-lg">
                Bugün hangi komisyon faaliyetlerinde yer alacaksınız?
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6">
          <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg md:rounded-xl lg:rounded-2xl p-3 md:p-4 lg:p-6 text-white relative overflow-hidden group hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-2 md:mb-3 lg:mb-4">
                <div className="w-8 h-8 md:w-10 md:h-10 lg:w-14 lg:h-14 bg-white bg-opacity-20 rounded-lg md:rounded-xl lg:rounded-2xl flex items-center justify-center">
                  <CheckCircleIcon className="w-4 h-4 md:w-5 md:h-5 lg:w-7 lg:h-7 text-emerald-800" />
                </div>
                <div className="text-emerald-100 text-xs lg:text-sm font-medium">Aktif</div>
              </div>
              <div className="text-xl md:text-2xl lg:text-3xl font-bold mb-1">{dashboardData.stats.active_memberships}</div>
              <div className="text-emerald-100 text-xs md:text-sm">Aktif Ortaklıklarım</div>
              <div className="text-xs text-emerald-200 mt-1 md:mt-2">Komisyon ortaklıklarınız</div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg md:rounded-xl lg:rounded-2xl p-3 md:p-4 lg:p-6 text-white relative overflow-hidden group hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-2 md:mb-3 lg:mb-4">
                <div className="w-8 h-8 md:w-10 md:h-10 lg:w-14 lg:h-14 bg-white bg-opacity-20 rounded-lg md:rounded-xl lg:rounded-2xl flex items-center justify-center">
                  <ClipboardDocumentListIcon className="w-4 h-4 md:w-5 md:h-5 lg:w-7 lg:h-7 text-blue-800" />
                </div>
                <div className="text-blue-100 text-xs lg:text-sm font-medium">Mevcut</div>
              </div>
              <div className="text-xl md:text-2xl lg:text-3xl font-bold mb-1">{dashboardData.stats.available_commissions}</div>
              <div className="text-blue-100 text-xs md:text-sm">Mevcut Komisyonlar</div>
              <div className="text-xs text-blue-200 mt-1 md:mt-2">Başvuru yapabileceğiniz</div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg md:rounded-xl lg:rounded-2xl p-3 md:p-4 lg:p-6 text-white relative overflow-hidden group hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-2 md:mb-3 lg:mb-4">
                <div className="w-8 h-8 md:w-10 md:h-10 lg:w-14 lg:h-14 bg-white bg-opacity-20 rounded-lg md:rounded-xl lg:rounded-2xl flex items-center justify-center">
                  <StarIcon className="w-4 h-4 md:w-5 md:h-5 lg:w-7 lg:h-7 text-purple-800" />
                </div>
                <div className="text-purple-100 text-xs lg:text-sm font-medium">Toplam</div>
              </div>
              <div className="text-xl md:text-2xl lg:text-3xl font-bold mb-1">{dashboardData.stats.total_commissions}</div>
              <div className="text-purple-100 text-xs md:text-sm">Toplam Katılım</div>
              <div className="text-xs text-purple-200 mt-1 md:mt-2">Geçmiş + mevcut</div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 lg:gap-6 mb-4 md:mb-6 lg:mb-8">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-lg md:rounded-xl lg:rounded-2xl p-3 md:p-4 lg:p-6 border border-orange-100">
                <div className="flex items-center mb-3 md:mb-4">
                  ...
                  <div className="ml-3 md:ml-4 flex-1 min-w-0">
                    <h3 className="font-bold text-gray-900 truncate text-sm md:text-base">Özetim</h3>
                    <p className="text-xs md:text-sm text-gray-600 truncate">Hızlı bilgiler</p>
                  </div>
                </div>
                <div className="space-y-1 md:space-y-2">
                  <div className="flex items-center justify-between text-xs md:text-sm">
                    <span className="text-gray-600">Aktif ortaklıklar</span>
                    <span className="font-semibold text-orange-600">{dashboardData?.stats?.active_memberships || 0}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">Başvuru yapılabilir</span>
                    <span className="font-semibold text-orange-600">{dashboardData?.stats?.available_commissions || 0}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-700">Aktif ortaklıklarım</span>
                </div>
                <span className="text-lg font-bold text-emerald-600">{dashboardData?.stats?.active_memberships || 0}</span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-700">Başvuru yapabileceğim</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-700">Toplam katılımım</span>
                </div>
                <span className="text-lg font-bold text-purple-600">{dashboardData?.stats?.total_commissions || 0}</span>
              </div>
            </div>
          </div>
