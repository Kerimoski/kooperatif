  ...
  return (
    <NotificationProvider>
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100">
        {/* Navigation */}
        <nav className="bg-white/80 backdrop-blur-lg shadow-xl border-b border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center">
              <Link href="/member" className="flex items-center">
                <div className="flex-shrink-0">
                  ...
                  <div className="ml-3 md:ml-4 hidden sm:block">
                    ...
                    <p className="text-xs md:text-sm text-gray-500">Ortak Paneli</p>
                </div>
              </Link>
            </div>
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-gray-500">Ortak</p>
              </div>
                <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center">
